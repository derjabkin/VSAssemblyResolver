...
namespace VSAssemblyResolver_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(SergejDerjabkin.VSAssemblyResolver.GuidList.guidVSAssemblyResolverCmdSet, (int)SergejDerjabkin.VSAssemblyResolver.PkgCmdIDList.cmdidPopulateToolbox);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VSAssemblyResolver", "SergejDerjabkin.VSAssemblyResolver.VSAssemblyResolverPackage");
