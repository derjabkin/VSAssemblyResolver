...
using SergejDerjabkin.VSAssemblyResolver;

namespace VSAssemblyResolver_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSAssemblyResolverPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(SergejDerjabkin.VSAssemblyResolver.GuidList.guidVSAssemblyResolverCmdSet, (int)SergejDerjabkin.VSAssemblyResolver.PkgCmdIDList.cmdidPopulateToolbox);
